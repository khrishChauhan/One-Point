...
export const projects: Project[] = [
  ...
  // -----------------------------------------------------
  {
    ...
    completedImages: [
      ...
      { src: imgResturant("WhatsApp Image 2026-05-26 at 12.53.59.jpeg"), alt: "Chango's Restaurant - Main dining hall overview", caption: "Main dining hall overview showcasing custom timber ceiling fins and seating zoning." },
      { src: imgResturant("WhatsApp Image 2026-05-26 at 12.54.00.jpeg"), alt: "Chango's Restaurant - Table seating layout detail", caption: "Detailed view of the banquette seating and warm wood wall cladding." },
      { src: imgResturant("WhatsApp Image 2026-05-26 at 12.54.00 (1).jpeg"), alt: "Chango's Restaurant - Atmospheric spot lighting", caption: "Close-up of ambient brass pendant lamps casting soft warm light over tables." },
      { src: imgResturant("WhatsApp Image 2026-05-26 at 12.54.00 (2).jpeg"), alt: "Chango's Restaurant - Interiors perspective view", caption: "Spatial perspective detailing transition from public dining to private lounge." },
      { src: imgResturant("WhatsApp Image 2026-05-26 at 12.54.03.jpeg"), alt: "Chango's Restaurant - Seating and lighting details", caption: "Perspective showcasing the integrated custom lighting and booth layouts." },
      { src: imgResturant("WhatsApp Image 2026-05-26 at 12.54.03 (1).jpeg"), alt: "Chango's Restaurant - Lounge and corridor details", caption: "Refined details showing modern woodwork and ambient shadows." },
      { src: imgResturant("WhatsApp Image 2026-05-26 at 12.54.03 (2).jpeg"), alt: "Chango's Restaurant - Architectural view", caption: "A wider view highlighting the ceiling design and layout transition." },
      { src: imgResturant("WhatsApp Image 2026-05-26 at 12.54.03 (3).jpeg"), alt: "Chango's Restaurant - Detail view", caption: "Focus on materiality and premium finishes." },
      { src: imgResturant("WhatsApp Image 2026-05-26 at 12.54.03 (5).jpeg"), alt: "Chango's Restaurant - Custom fixtures", caption: "Custom designed partition walls and architectural elements." },
      { src: imgResturant("WhatsApp Image 2026-05-26 at 12.54.03 (6).jpeg"), alt: "Chango's Restaurant - Interior partition", caption: "Bespoke partition screen design separating dining sections." },
      { src: imgResturant("WhatsApp Image 2026-05-26 at 12.54.03 (7).jpeg"), alt: "Chango's Restaurant - Dining ambience", caption: "Atmospheric evening lighting setting a luxury vibe." },
      { src: imgResturant("WhatsApp Image 2026-05-26 at 12.54.03 (8).jpeg"), alt: "Chango's Restaurant - Spatial flow", caption: "View showcasing transition spaces and spatial flow." },
      { src: imgResturant("WhatsApp Image 2026-05-26 at 12.54.03 (9).jpeg"), alt: "Chango's Restaurant - Furniture details", caption: "Close-up of premium fabric choice and woodwork." },
      { src: imgResturant("WhatsApp Image 2026-05-26 at 12.54.03 (10).jpeg"), alt: "Chango's Restaurant - Lounge area", caption: "Comfortable lounge area highlighting texture and materials." },
      { src: imgResturant("WhatsApp Image 2026-05-26 at 12.54.03 (11).jpeg"), alt: "Chango's Restaurant - Interior view", caption: "Overview of the restaurant showing structural elements." },
      { src: imgResturant("WhatsApp Image 2026-05-26 at 12.54.03 (12).jpeg"), alt: "Chango's Restaurant - Lighting fixture", caption: "Detail of bespoke architectural light fitting." },
      { src: imgResturant("WhatsApp Image 2026-05-26 at 12.54.03 (13).jpeg"), alt: "Chango's Restaurant - Dining zone", caption: "Intimate family dining zone with warm acoustics." },
      { src: imgResturant("WhatsApp Image 2026-05-26 at 12.54.03 (14).jpeg"), alt: "Chango's Restaurant - Backlit panels", caption: "Custom brass backlight wall panels creating visual depth." },
      { src: imgResturant("WhatsApp Image 2026-05-26 at 12.54.03 (15).jpeg"), alt: "Chango's Restaurant - Modern corner", caption: "Modern geometric corners illustrating precision design." },
      { src: imgResturant("WhatsApp Image 2026-05-26 at 12.54.03 (16).jpeg"), alt: "Chango's Restaurant - Overview perspective", caption: "Elegant perspective of the central dining layout." },
    ],
    constructionImages: [],
  },
  {
